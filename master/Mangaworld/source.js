...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Mangaworld = exports.MangaworldInfo = exports.isLastPage = void 0;
const types_1 = require("@paperback/types");
const MangaworldParser_1 = require("./MangaworldParser");
...
class Mangaworld {
    constructor(cheerio) {
        ...
        this.parser = new MangaworldParser_1.Parser();
    }
    // TODO
    ...
    async getHomePageSections(sectionCallback) {
        ...
        let url = `${DOMAIN}/archive?sort=most_read`;
        const $ = await this.DOMHTML(url);
        const section = App.createHomeSection({ id: 'most_read', title: 'I più letti', type: types_1.HomeSectionType.singleRowLarge, containsMoreItems: false });
...
},{"./MangaworldParser":71,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    parseViewMoreSection($, homepageSectionId) {
        switch (homepageSectionId) {
            case 'featured':
